...
-- Fix all database functions to avoid GROUP BY issues with json_agg and ORDER BY

-- Fix get_user_vitals function
...
-- Fix get_user_medications function
...
-- Fix get_user_symptoms function
...
-- Fix get_user_comorbidities function
